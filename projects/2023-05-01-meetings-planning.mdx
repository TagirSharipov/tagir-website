...
I took the existing project and added new pages.
I also redesigned the calendar component and added functionality to schedule multiple meetings in a single slot.
