...
I was responsible for the development of the frontend part of the application. 
I took the existing project and extended it. 75% of the current portal is my work.
I worked closely with the backend team to ensure the integration of the frontend with the backend. 
I also collaborated with the design team to ensure the implementation of the design according to the specifications.
